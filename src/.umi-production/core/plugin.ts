...
import * as Plugin_1 from 'C:/台州能源/_web/src/.umi-production/plugin-dva/runtime.tsx';
...
export function getPlugins() {
  return [
    ...
    {
      apply: Plugin_1,
      path: process.env.NODE_ENV === 'production' ? void 0 : 'C:/台州能源/_web/src/.umi-production/plugin-dva/runtime.tsx',
    },
  ];
}
